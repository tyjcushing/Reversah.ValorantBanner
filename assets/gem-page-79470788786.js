...
(function( jQuery ){
  var $module = jQuery('#m-1619779798409').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1619779798409";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1619779798409") {
      window.getTab1619779798409 = function() {
...
(function( jQuery ){
  var $module = jQuery('#m-1620157148207').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1620157148207";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1620157148207") {
      window.getTab1620157148207 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1620157197572').children('.module');   
